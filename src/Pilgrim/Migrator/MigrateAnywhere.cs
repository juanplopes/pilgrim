...
namespace Pilgrim.Migrator
{
    ...
    public class MigrateAnywhere : BaseMigrate
    {
        ...
        public MigrateAnywhere(List<long> availableMigrations, ITransformationProvider provider, ILogger logger, string schemainfoname)
            : base(availableMigrations, provider, logger, schemainfoname)
        {
			_current = 0;
        ...
        public override void Migrate(IMigration migration, string schemainfoname)
        {
