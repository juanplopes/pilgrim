...
namespace Pilgrim.Providers
{
    ...
    public abstract class Dialect 
    {
        ...
        public ITransformationProvider NewProviderForDialect(string invariantProvider, string connectionString)
        {
            return (ITransformationProvider) Activator.CreateInstance(TransformationProvider, this, invariantProvider, connectionString);
        }
